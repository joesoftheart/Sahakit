                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <table width="100%" class="table table-striped table-hover table-responsive"
                                    ...
                                    <?php
                                    $sql_register = "SELECT * FROM teacher INNER JOIN student ON student.tid = $tid INNER JOIN register_work ON student.sid = register_work.sid WHERE teacher.tid = $tid";
                                    ...
                                    <?php for ($i = 1; $row_register = mysqli_fetch_array($query_regiswork); $i++) { ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <?php if($row_register['status_work'] == 1) { ?>
