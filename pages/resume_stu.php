...
<div class="book">
    <div class="page">
        <div class="subpage">
            <form action="../php/get_form_resume_stu.php" method="post" enctype="multipart/form-data">
            <br>
            <div align="center"><h4>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp; <b>- น้ำหนัก &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                :</b> <input type="text" name="weight" data-onload="set_size($(this),100)"> <br>
            &nbsp;&nbsp;&nbsp;&nbsp; <b> - ส่วนสูง &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="page">
        <div class="subpage">
            ...
            <textarea  name="study_detail" data-onload="set_size($(this),550)" style="margin-top: 5px;"
                      rows="15">รายละเอียดการศึกษา :</textarea>
            <br> <br>
