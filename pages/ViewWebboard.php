        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <table class="table table-bordered" width="100%" border="1" >
                    <tr>
                        <td colspan="2"><h4> ชื่อกระทู้ : <?php echo $objResult["Question"];?><i class="fa fa-question-circle" aria-hidden="true"></i></h4></td>
                    </tr>
                    <tr>
                        <td height="53" colspan="2">เนื้อหาเพิ่มเติม : <?php echo $objResult["Details"];?></td>
                    </tr>
                    <tr>
                        <td width="397">ผู้ตั้งกระทู้ : <?php echo $objResult["Name"];?> สร้างเมื่อวันที่ : <?php echo $objResult["CreateDate"];?></td>
                        <td width="253">จำนวนผู้เข้าชม : <?php echo $objResult["View"];?> จำนวนการตอบ : <?php echo $objResult["Reply"];?></td>
                    </tr>
                </table>
                <br>
                <br>
                ...
                {
                    $intRows++;
                    ?><h5 style="margin-left:5em ">ตอบ : <i class="fa fa-commenting" aria-hidden="true"></i></h5>
                    <table class="table table-bordered"  width="50%" border="1" cellpadding="1" cellspacing="1">

                        <tr>
                            <td height="53" colspan="2"><?php echo ($objResult2["Details"]);?></td>
                        </tr>
                        <tr>
                            <td width="397">ชื่อผู้ตอบ :
                                <?php echo $objResult2["Name"];?>      </td>
                            <td width="253">ตอบวันที่ :
                ...
                ?>
                <br>
                <a href="Webboard.php">กลับสู่บอร์ด</a> <br>
                <br>
                <form action="ViewWebboard.php?QuestionID=<?php echo $_GET["QuestionID"];?>&Action=Save" method="post" name="frmMain" id="frmMain">
                    <table class="table table-bordered" width="60%" border="1" cellpadding="1" cellspacing="1">
                        <tr>
                            <td><textarea name="txtDetails" cols="50" rows="5" id="txtDetails"></textarea></td>
                        </tr>
                        <tr>
                            <td width="647">ชื่อผู้ตอบ :<input name="txtName" type="text" id="txtName" value="" size="50"></td>
                        </tr>
                    </table>

                    <input name="btnSave" type="submit" id="btnSave" value="โพสต์">
                </form>
            </div>
